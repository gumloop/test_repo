...
def checksum(f: str, a: str = 'sha256') -> str:
    """Calculate the checksum of a file using a specified algorithm (default SHA256)."""
    h = hashlib.new(a)
...
def date_str(f: str = "%Y-%m-%d") -> str:
    """Return current date as a string formatted according to the given format string."""
...
if __name__ == "__main__":
    # Example use of capitalize_first function.
